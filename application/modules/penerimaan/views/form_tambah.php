<div class=" col-md-12">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h4 class="text-center tebal">FORM TAMBAH PENERIMAAN BARANG</h4>
        </div>
        <div class="panel-body">
            <div class="col-lg-12">
                <form id="penerima_form" class="form-horizontal" action="<?php echo $urlnya . 'penerimaan/proses_tambah' ?>" method="post">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label name="Program" id="kategori">Toko</label>
                                    <select class="form-control chosen-select" name="toko">
                        ...
                        <div class="panel-body">
                            <div class="collapsed in" id="collapsePajak">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <label for="Nilai">Satuan</label>
                                        <input type="text" class="form-control" name = "satuan" placeholder="satuan">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="Nilai">Harga Satuan</label>
                                        <div class="input-group">
                                            <div class="input-group-addon">Rp</div>
                                            <input id="nilai" type="text" class="form-control" name="nilai" placeholder="Masukkan Nilai">
                                            <input id="nilai_val" type="hidden" class="hidden" >
