...
<html lang="en">
    <head>
        ...
        <script src="<?php echo js('annyang.min.js'); ?>" type="text/javascript"></script>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo site_url(); ?>">
                        <img src="<?php echo base_url(); ?>/themes/images/logo.png" alt="logo">
            ...
            <div class="col-md-8">
                <div class="panel" style="margin-top: 15px;">
                    <div class="panel-heading bg-warning">
                        <h1 class="enjoy-css">ePenatausahaan</h1>
                        <ul class="sub-judul">
                    ...
                    <div class="panel-body">
                        <div style="margin: 0 auto; min-height: 260px; text-align: center; position: relative;">
                            <!--<h3>Apa itu ePenatausahaan?</h3>-->
                            <p style="position: absolute; top: 100px;">ePenatausahaan adalah sistem yang dipakai dalam proses penatausahaan keuangan yang terintegrasi dengan sistem Rencana Kerja Operasional yaitu e-project planning dan sistem Pengendalian yaitu e-controlling.</p>
                            <h2 id="infonya" class="animated fadeIn infinite" style="text-align: center; color: #2a70d0;/*#f00*/font-size: 1.4em;">Aplikasi telah dibuka dan menggunakan Database Asli.</h2>
                        </div>
                    </div>
<!--                    <div class="panel-footer bg-danger">
                ...
                <div class="login animated bounceIn">
                    <div class="login-screen border-top-blue">
                        ...
                        <form class="form-horizontal" id="LoginForm" method="post" action="">
                            ...
                            <!-- <div class="list-inline" style="margin: 15px 0px; text-align: center;">
                                <li><a href="#" class="btn-link" onclick="lupas()">Lupa Password?</a></li>
                            </div> -->
                            <div class="control-group">
                                <div class="chap">
        ...
        <div class="copyright">
            <span>Copyright &copy <?php echo date("Y"); ?> <a href="http://jatengprov.go.id">Pemerintah Provinsi Jawa Tengah</a></span>
        </div>
        <?php
        ...
        ?>, {
                    ...
                    callbacks: {
                        ...
                        stop: function () {
                            ...
                            $("#infonya").html("Aplikasi telah dibuka dan memakai database Asli");
                        },
                        start: function () {
